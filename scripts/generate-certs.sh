...
generate_cert "benefits.gov.uk.local"
...
server {
    listen 80;
    server_name pds.local dro.gov.uk.local benefits.gov.uk.local;
...
# HTTPS server for benefits.gov.uk.local
server {
    listen 443 ssl;
    server_name benefits.gov.uk.local;
    
    ssl_certificate /etc/nginx/certs/benefits.gov.uk.local.crt;
    ssl_certificate_key /etc/nginx/certs/benefits.gov.uk.local.key;
...
echo "127.0.0.1  benefits.gov.uk.local"
